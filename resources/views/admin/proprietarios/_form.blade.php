...
@component('form._form_group', ['field' => 'agencia'])
    {!! Form::label('agencia', 'Agencia', ['class' => 'control-label']) !!}
    {!! Form::text('agencia', null, ['class' => 'form-control']) !!}
@endcomponent

@component('form._form_group', ['field' => 'conta'])
    {!! Form::label('conta', 'Conta', ['class' => 'control-label']) !!}
    {!! Form::text('conta', null, ['class' => 'form-control']) !!}
@endcomponent

@component('form._form_group', ['field' => 'operacao'])
    {!! Form::label('operacao', 'Operação', ['class' => 'control-label']) !!}
...
{!! Form::hidden('endereco_id', $proprietario['endereco_id']) !!}
